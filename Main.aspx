...
<head runat="server">
    <title>Microsoft Dynamics 365 Business Central Help</title>
    <meta http-equiv="X-UA-Compatible" content="IE=9; IE=10" />
    <link href="/css/msdnTheme.css" rel="stylesheet" type="text/css" />
    <link rel="shortcut icon" href="images/setupBc.ico" type="image/x-icon" />
...
<body class="library" onload="init()">
    <div id="page">
        <div class="FF ltr" id="ux-header">
            <h1 class="title">
                <asp:Label runat="server" Text="Microsoft Dynamics 365 Business Central" ID="ProductName"/></h1>
                ...
                <div id="mainSection">
                    <div id="mainBody">
                        <iframe name="mainContentIFrame"
                                ...
                                scrolling="no" 
                                src="<%=ResolveUrl("~/help/" + Context.Request.QueryString["lang"] + "/" + Context.Request.QueryString[ContentQueryStringKey])%>"/>
                    </div>
                </div>
            </div>
        </div>
